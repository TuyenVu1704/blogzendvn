...
export default function ArticleItemInfo({ isShowAvatar, authorData, publishedDate }) {
  const { nickname, avatar } = authorData;
  return (
    <div className="article-item__info">
      {isShowAvatar && <ArticleItemAvatar avatar={avatar} nickname={nickname} />}
